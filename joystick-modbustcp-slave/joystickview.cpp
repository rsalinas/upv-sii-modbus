    ...
    , isDragging(false)
{
    ...
    pointer = new MovableCircle(-15, -15, 30, 30);
...
void GraphicsView::returnToCenter()
{
    ...
    timer->start(20);   // Iniciar el temporizador cuando se suelta el ratón
}
...
void GraphicsView::keyPressEvent(QKeyEvent *event)
{
    ...
    // Solo actualizar keysPressed si es una de las 4 teclas permitidas
    int key = event->key();
...
void GraphicsView::keyReleaseEvent(QKeyEvent *event)
{
    ...
    if (keysPressed.isEmpty()) {
        ...
        qDebug() << "Keys are still being pressed: " << keysPressed;
    }
}
